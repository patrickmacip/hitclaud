...
{
  chk('hay exactamente 31 versiones', B.versiones.length === 31);
  chk('la primera entrada es la 3.6 (más reciente primero)', B.versiones[0].version === '3.6');
  chk('la 3.6 trae su punto literal (siempre un objetivo bueno)', (function () {
    const v = B.versiones[0];
    return v.version === '3.6' && v.fecha === '3 de agosto' && v.puntos.length === 1 &&
      v.puntos[0].texto === 'Siempre aparece un objetivo bueno al que apuntar';
  })());
  chk('la segunda entrada es la 3.5 (intacta)', (function () {
  ...
  chk('la tercera entrada es la 3.4 (intacta)', (function () {
  ...
  chk('la cuarta entrada es la 3.3 (intacta)', (function () {
  ...
  chk('la quinta entrada es la 3.2 (intacta)', (function () {
  ...
  chk('la sexta entrada es la 3.1 (intacta)', (function () {
  ...
  chk('la séptima entrada es la 3.0 (intacta)', (function () {
    const v = B.versiones[6];
  ...
  chk('la octava entrada es la 2.9 (intacta)', B.versiones[7].version === '2.9' && B.versiones[7].puntos.length === 4 && B.versiones[7].puntos[0].texto === 'Llega Pushcloude: aplasta los targets con el dedo');
  chk('la novena entrada es la 2.8 (intacta)', B.versiones[8].version === '2.8' && B.versiones[8].puntos[0].texto === 'Pushcloude entra en acceso anticipado para quien tenga la clave');
  chk('la décima entrada es la 2.7 (intacta)', B.versiones[9].version === '2.7' && B.versiones[9].puntos[0].texto === 'El juego se llama Hitcloude');
  chk('la undécima entrada es la 2.6 (intacta)', B.versiones[10].version === '2.6' && B.versiones[10].puntos.length === 2);
  chk('la duodécima entrada es la 2.5 (intacta)', B.versiones[11].version === '2.5' && B.versiones[11].puntos.length === 3);
  chk('la decimotercera entrada es la 2.4 (intacta)', B.versiones[12].version === '2.4' && B.versiones[12].puntos[2].texto === 'El juego siempre abre en HitClaud');
  chk('la decimocuarta entrada sigue siendo la 2.3', B.versiones[13].version === '2.3');
