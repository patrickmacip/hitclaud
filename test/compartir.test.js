...
(async function () {
  ...
  {
    chk('botón Compartir en el fin de partida (icono en la cabecera, como en el ranking)', /<button id="compartirFin" class="hdr-icono"[\s\S]{0,140}#ic-compartir/.test(html));
