...
console.log('=== PRIMERA carga pide nombre y BLOQUEA; SEGUNDA no ===');
{
  ...
  chk('overlay #nombre registrado como overlay real (posición z-index:3 + ocultado compuesto)', /<div id="nombre" class="oculto" role="dialog"/.test(html) && /#gameover, #inicio, #duracion, #nombre, #actualizaciones, #ranking \{/.test(css) && /#nombre\.oculto/.test(css));
